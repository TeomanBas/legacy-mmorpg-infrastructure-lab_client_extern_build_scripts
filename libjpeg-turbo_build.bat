...
echo =====================================
echo     LIBJPEG-TURBO BUILD SCRIPT
echo =====================================
...
set SOURCE_DIR=%ROOT_DIR%\libjpeg-turbo
set BUILD_ROOT=%ROOT_DIR%\build\libjpeg-turbo
...
if not exist "%SOURCE_DIR%" (
    echo [ERROR] libjpeg-turbo source not found
    pause
    exit /b 1
)
...
echo.
echo =====================================
echo   LIBJPEG-TURBO BUILD COMPLETED
echo =====================================
pause
exit /b 0
...
REM =========================
REM OUTPUT LIB NAME (optional future use)
REM =========================
...
echo.
echo =====================================
echo Building libjpeg-turbo %PLATFORM% - %CONFIG%
echo =====================================
