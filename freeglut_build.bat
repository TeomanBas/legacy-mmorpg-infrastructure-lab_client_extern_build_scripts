...
set SOURCE_DIR=%ROOT_DIR%\freeglut
set BUILD_ROOT=%ROOT_DIR%\build\freeglut
...
if not exist "%SOURCE_DIR%\CMakeLists.txt" (
    echo [ERROR] freeglut source not found!
    pause
    exit /b 1
)
...
echo.
echo =====================================
echo Building freeglut %PLATFORM% - %CONFIG%
echo =====================================
