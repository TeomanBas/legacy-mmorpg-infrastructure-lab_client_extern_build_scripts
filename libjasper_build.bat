...
set SOURCE_DIR=%ROOT_DIR%\jasper
set BUILD_ROOT=%ROOT_DIR%\build\jasper
...
echo [ERROR] Jasper source not found!
pause
exit /b 1
)
...
echo.
echo =====================================
echo Building Jasper %PLATFORM% - %CONFIG%
echo =====================================
